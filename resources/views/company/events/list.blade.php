...
<div>
	<h5 class="ct mt-4">Upcoming Events & Weddings</h5></div>
<div>
	<h5 class="ct mt-4">
  @if(auth()->user()->user_type=='company')
    <a href="{{url('company/add-event')}}" class='btn bookbtn'>Create Event</a>
    @endif
	</h5></div>
</nav>
@if(auth()->user()->user_type=='user')
<form method="get" action="{{url('/user/event-list')}}" name="search">
@else
<form method="get" action="{{url('/company/event-list')}}" name="search">
@endif
    <div class="row mt-3">
      <div class="col-md-3">
      ...
      <div class="col-md-3" style="position: relative">
         <input type="text" name="date_from" placeholder="From Date" class="form-control bg-white" id="datepickerFrom" class="datepicker" readonly>
		  <img src="{{asset('images/icons/calender.png')}}" onclick="dateselect('datepickerFrom')" class="cal-icon" id="seedate1">
      </div>
      <div class="col-md-3" style="position: relative">
         <input type="text" name="date_to"  placeholder="To Date" class="form-control bg-white" id="datepickerTo" class="datepicker" readonly>
...
<table class="table mt-4 lbl">
  ...
  <tbody id="eventList">
    ...
    <tr>      
      ...
      <td>{{$event->event_type=='single' ? 'Single Day':'Multi Day'}}</td>
      @if(auth()->user()->user_type=='user')
      <td>{{$event->companyLegalName()}}</td>
      @endif
      <td>
        <a href="{{url('/event').'/'.(strtolower(str_replace(' ','-',$event->companyLegalName()))).'/'.$event->page_slug}}" style='color: #07269B' target='_blank'>View</a>&nbsp; &nbsp; &nbsp;
        @if(auth()->user()->user_type=='company')
		  <span style='color: #07269B; text-decoration: underline' data-bs-toggle="modal" data-bs-target="#editmodal" onClick="getEvent({{$event->id}})">Edit</span>
          @endif
      </td>
      @if(auth()->user()->user_type=='user')
      <td>		  
		@php
		  $is_booked=DB::table('bookings')->where([['user_id',auth()->user()->id],['event_id',$event->id]])->first();
		 @endphp
		  @if($is_booked)
		  <button class="btn bookbtn" style="background-color:#27C22C; width: 100px; text-align: center; padding-left:0; padding-right: 0">Booked</button>
		  @else
		  <a href="{{url('/user/event').'/'.$event->id}}" class="btn bookbtn" style="width: 100px; text-align: center; padding-left:0; padding-right: 0">Book</a>
		  @endif
		</td>
      @endif
    </tr>
...
<!-- Modal -->
    <div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">		
            <div class="modal-content ps-5 pt-3"> 
                ...
                <div class="mt-4">
                    <form method="post" enctype="multipart/form-data" id="updateEvent">
                        @csrf
                        ...
                        <div class="row mt-3 width-adjust">
                            ...
                            <div class="col-sm-9 col-7">
                                <input type="text" name="event_name"name="event_name" id="event_name" class="form-control" value=""></div>
                        ...
                        <div class="row mt-3 width-adjust">
                            ...
                            <div class="col-sm-9 col-7">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <select class="form-control form-select" name="event_type" id="event_type" onclick="flipday(this)" onchange="flipday(this)">                                                              
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6" style="position: relative">
                                            <input type="text" class="form-control bg-white" name="event_date" id="datepicker"
                                                class="datepicker" value="" readonly>
                                ...
                                <div class="col-sm-9 col-7">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="time" name="event_time_from" id="event_time_from" class="form-control" value="">
                                            <span class="error_event_time_from qerr"></span>
                                        </div>

                                        <div class="col-sm-6 up1">
                                            <input type="time" name="event_time_to" id="event_time_to" class="form-control" value="">
                        ...
                        <div id="multiday" style="display: none;">
                            <div class="row mt-3 width-adjust">
                                ...
                                <div class="col-sm-9 col-7">
                                    <div class="row">
                                        <div class="col-sm-6" style="position: relative">
                                            <input type="text" class="form-control bg-white" id="datepicker1" class="datepicker" name="event_date_from"  value="">
                                            <img src="{{asset('images/icons/calender.png')}}" id="seedate1"
                            ...
                            <div class="row mt-3 width-adjust">
                                ...
                                <div class="col-sm-9 col-7">
                                    <div class="row">
                                        <div class="col-sm-6" style="position: relative">
                                            <input type="text" class="form-control bg-white" id="datepicker2" class="datepicker" name="event_date_to"  value="" readonly>
                        ...
                        <input type="hidden" name="event_about" id="event_about" value="" id="eventabout">
                        <div class="ex1 mt-3 ps-1">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event5">Award Ceremony</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event14">Coaching Session</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" id="event15">Cocktail Party</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event16">Company Party</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" id="event17">Conference</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event18">Conference Room</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" id="event19">Convention</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event20">Corporate Event</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event21">Corporate Meeting</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event22">Corporate Party</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event23">Creative Meeting</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event28">Fashion Shoot</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" id="event29">Film Shoot</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event30">Film Studio</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event35">Kick Off Meeting</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event40">Networking Event</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" id="event41">Off-Site</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event42">Outdoor Event</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event43">Outdoor Party</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event44">Outdoor Venues</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" id="event48" style="padding-left: 10px; padding-right: 10px">Press Conference</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event51">Production Studio</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event60">Video Shoot</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                                    <div class="card vec" onclick="selectEvent(this)" style="padding-left: 10px; padding-right: 10px" id="event61">Video Studio</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12 p-2">
                        ...
                        <div id="mappie">
                            <div class="width-adjust">
                                ...
                                <div class="mt-2 w-100">
                                    <input type="text" class="form-control" id="autocomplete" name="event_map_address"  value=""
                        ...
                        <div id="addrForm" style="display: none">
                            <div class="row mt-3 width-adjust">
                                ...
                                <div class="col-sm-9 col-7"><input type="text" name="address1" id="address1" class="form-control" value=""></div>
                                <span class="error_address1 qerr"></span>
                            </div>
                            <div class="row mt-3 width-adjust">
                                <div class="col-sm-3 col-5 mt-2 lbl">Address Line 2</div>
                                <div class="col-sm-9 col-7"><input type="text" name="address2" id="address2" class="form-control"></div>
                        ...
                        <div class="row width-adjust mt-2">
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="max_no_of_guest" id="max_no_of_guest">
                        ...
                        <div class="card titlehead mt-3">Venue & Booking</div>
                        ...
                        <div class="row width-adjust">
                            ...
                            <div class="col-md-3 col-sm-9 col-7 mt-3">
                                <div class="input-group"><span class="input-group-text" id="basic-addon1">$</span><input type="text"
                                        class="form-control" name="deposit_amount" id="deposit_amount"></div>
                                <span class="error_deposit_amount qerr"></span>
                            </div>
                        </div>
                        <div class="row width-adjust">
                            <div class="col-md-3 col-sm-3 col-5 mt-3 lbl">Last Date of Deposit</div>
                            <div class="col-md-3 col-sm-9 col-7 mt-3" style="position: relative">
                                <input type="text" class="form-control bg-white" name="deposit_last_date" id="datepicker3"
                                    class="datepicker" readonly>
                                <img src="{{asset('images/icons/calender.png')}}" id="seedate1" onclick="dateselect('datepicker3')" class="cal-icon">
                            </div>
                        ...
                        <div class="row width-adjust">
                            ...
                            <div class="col-md-3 col-sm-9 col-7 mt-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="canc_waiver" id="canc_waiver">
                                </div>
                        ...
                        <div class="card titlehead mt-3">Page Details</div>
                        <div class="row width-adjust mt-3">
                            <div class="col-sm-3 col-5 mt-2 lbl">Page Title</div>
                            <div class="col-sm-9 col-7">
                                <input type="text" class="form-control mt-2" name="page_title" id="page_title" placeholder="Enter post title"
                        ...
                        <div class="row width-adjust mt-3">
                            ...
                            <div class="col-sm-9 col-7">
                                <input type="text" class="form-control mt-2" name="page_slug" id="page_slug" placeholder="Slug" id="slug" readonly
                                    required>
                            </div>
                        ...
                        <div class="row width-adjust mt-3">
                            ...
                            <div class="col-sm-9 col-7">
                                <textarea class="form-control" rows="5" name="page_about" id="page_about" required></textarea>
                            </div>
                        ...
                        <div class="row width-adjust mt-3">
                            ...
                            <div class="col-md-2">
                                <img id="old_logo" style="height:150px;width:150px;">
                            </div>
                        ...
                        <div class="row width-adjust mt-3">
                            ...
                            <div class="col-md-2">
                                <img id="old_fimg" style="height:150px;width:150px;">
                            </div>
                        ...
                        <div class="updateEventStatusMsg"></div>
                        <div class="mt-4 mb-3">
                            <button type="button" class="btn bluebutton" id="updateEventBtn" onClick="updateEvent()">Update</button>
...
<script>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDC8UYJzlbQWQJ0WRATn-_mubFcp9pgI2I&libraries=places&callback=initAutocomplete" async differ> </script>
...
function updateEvent() {
    ...
    $('.qerr').html('');
    $('.updateEventStatusMsg').html('');

    var form = $('#updateEvent')[0];		 
    ...
    $.ajax({
        ...
        timeout: 600000,      
        beforeSend: function() {
            $('.updateEventStatusMsg').html('<div class="card successcard">Processing......</div>');
            
           },  
        success:function(response){
            $("#updateEventBtn").delay(5000);
            $('.updateEventStatusMsg').html('');
            ...
            if( response.status == true ) {
                ...
                $('.updateEventStatusMsg').html('<div class="card successcard">'+response.msg+'</div>');
        ...
        $.ajax({
            ...
            success: function (response) {
                // alert(response.status);
                 ...
                 $('#event_type').val(response.event.event_type);
                 $('#datepicker').val(response.event.event_date);
                 $('#datepicker1').val(response.event.event_date_from);
                 $('#datepicker2').val(response.event.event_date_to);
                 $('#event_time_from').val(response.event.event_time_from);
                 $('#event_time_to').val(response.event.event_time_to);
                 $('#event_about').val(response.event.event_about);
                 $('#autocomplete').val(response.event.event_map_address);
                 $('#address1').val(response.event.address1);
                 $('#address2').val(response.event.address2);
                 $('#country').val(response.event.country);
                 $('#state').val(response.event.state);
                 $('#zipcode').val(response.event.zipcode);
                 $('#max_no_of_guest').val(response.event.max_no_of_guest);
                 $('#hotel_name').val(response.event.hotel_name);
                 $('#sor').val(response.event.single_occupancy);
                 $('#dor').val(response.event.double_occupancy);
                 $('#deposit_amount').val(response.event.deposit_amount);
                 $('#datepicker3').val(response.event.deposit_last_date);
                 $('#canc_waiver').val(response.event.canc_waiver);
                 
                 $('#page_title').val(response.event.page_title);
                 $('#page_slug').val(response.event.page_slug);
                 $('#page_about').val(response.event.page_about);
                 $("#old_logo").attr("src","{{url('images')}}/"+response.event.logo);
                 $("#old_fimg").attr("src","{{url('images')}}/"+response.event.feature_image);
                 

                //  var per=100/response.images.length;
                 $.each(response.images, function (i, img) {
                    
                     $('#oldImagesDiv').append(`
                     <div  class="col-md-2">
                        <img src="{{url('images')}}/`+img.image+`" style="height:100px;">
                     </div>                            
                       `);
                 });


                 $.each(response.packages, function (i, pack) {
                    
                    $('#addpackage').append(`
                    <div class="row width-adjust mt-3">
                                <div class="col-sm-3 col-5 mt-2 lbl">Package Name</div>
                                <div class="col-sm-9 col-7"><input type="text" class="form-control" name="package_name[]" id="package_name[]" value="`+pack.package_name+`" required>
                                </div>
                            ...
                            <div class="row width-adjust">
                                ...
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <div class="input-group"><span class="input-group-text" id="basic-addon1">$</span><input type="text"
                                            class="form-control" name="price_per_adult[]" id="price_per_adult[]" value="`+pack.price_per_adult+`" required></div>
                                </div>
                                <div class="col-md-3 col-sm-3 col-5 mt-3 lbl">Price Per Adult<br><span class="minitext">Extended</span>
                                </div>
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <div class="input-group"><span class="input-group-text" id="basic-addon1">$</span><input type="text"
                                            class="form-control" name="price_per_adult_extended[]" value="`+pack.price_per_adult_extended+`" id="price_per_adult_extended[]" required></div>
                                </div>
                            </div>
                            <div class="row width-adjust">
                                <div class="col-md-3 col-sm-3 col-5 mt-3 lbl">Max no. of Adults Allowed</div>
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <input type="text" class="form-control" name="max_allowed_adult[]" id="max_allowed_adult[]" value="`+pack.max_allowed_adult+`" required>
                                </div>
                            </div>
                            ...
                            <div class="row width-adjust">
                                ...
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1">$</span>
                                        <input type="text" class="form-control" name="price_per_teenager[]" id="price_per_teenager[]" value="`+pack.price_per_teenager+`" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <div class="input-group"><span class="input-group-text" id="basic-addon1">$</span><input type="text"
                                            class="form-control" name="price_per_teenanger_extended[]" id="price_per_teenanger_extended[]" value="`+pack.price_per_teenager_extended+`" required></div>
                                </div>
                            </div>
                            <div class="row width-adjust">
                                ...
                                <div class="col-md-3 col-sm-9 col-7 mt-3"><input type="text" class="form-control"
                                        name="max_allowed_teenager[]" id="max_allowed_teenager[]" value="`+pack.max_allowed_teenager+`" required></div>
                            </div>
                            <hr class="mt-5 width-adjust">
                            <div class="row width-adjust">
                                ...
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <div class="input-group"><span class="input-group-text" id="basic-addon1">$</span><input type="text"
                                            class="form-control" name="price_per_child[]" id="price_per_child[]" value="`+pack.price_per_child+`" required></div>
                                </div>
                                <div class="col-md-3 col-sm-3 col-5 mt-3 lbl">Price Per Child/Infant<br><span
                                        class="minitext">Extended</span></div>
                                <div class="col-md-3 col-sm-9 col-7 mt-3">
                                    <div class="input-group"><span class="input-group-text" id="basic-addon1">$</span><input type="text"
                                            class="form-control" name="price_per_child_extended[]" id="price_per_child_extended[]" value="`+pack.price_per_child_extended+`" required></div>
                                </div>
                            </div>
                            <div class="row width-adjust">
                                <div class="col-md-3 col-sm-3 col-5 mt-3 lbl">Max no. of Children/ Infants Allowed</div>
                                <div class="col-md-3 col-sm-9 col-7 mt-3"><input type="text" class="form-control"
                                        name="max_allowed_child[]" id="max_allowed_child[]" value="`+pack.max_allowed_child+`" required></div>
                            </div>
                            <hr>
                    `);
                    // $('#price_per_adult').val(pack.price_per_adult);
                    // $('#price_per_adult_extended').val(pack.price_per_adult_extended);
                    // $('#max_allowed_adult').val(pack.max_allowed_adult);
                    // $('#price_per_teenager').val(pack.price_per_teenager);
                    // $('#price_per_teenager_extended').val(pack.price_per_teenager_extended);
                    // $('#max_allowed_teenager').val(pack.max_allowed_teenager);
                    // $('#price_per_child').val(pack.price_per_child);
                    // $('#price_per_child_extended').val(pack.price_per_child_extended);
                    // $('#max_allowed_child').val(pack.max_allowed_child);
